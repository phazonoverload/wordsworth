...
describe('analyzeReadability', () => {
  ...
  it('includes audience note when reader context provided', () => {
    const result = analyzeReadability(simpleText, 'Junior frontend developer')
    expect(result.audienceNote).toContain('Junior frontend developer')
  })
